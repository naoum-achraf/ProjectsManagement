...
var areachartSalesColors = getChartColorsArray("sales-forecast-chart"),
  ...
  chart = new ApexCharts(document.querySelector("#sales-forecast-chart"), options);
chart.render();
var chartDonutBasicColors = getChartColorsArray("store-visits-source"),
  options = {
    series: [44, 55, 41, 17, 15],
    labels: ["Edu", "Tre", "Fora", "Cim du maroc", "ONPAC"],
    chart: {
      height: 333,
      type: "donut"
    },
